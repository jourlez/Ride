...
intersphinx_mapping = {
    'docs': ('https://docs.decentralchain.io/es/master/', None),
}
...
latex_documents = [
    (master_doc, 'ride.tex', 'Ride Documentation',
     'Jourlez', 'manual'),
]
...
man_pages = [
    (master_doc, 'Ride', 'Ride Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Ride', 'Ride Documentation',
     author, 'Ride', 'One line description of project.',
     'Miscellaneous'),
]
